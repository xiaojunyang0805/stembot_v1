    ...
    >
      <div className="relative">
        <Sun
          size={iconSize[size]}
          className={cn(
            'absolute transition-all duration-300 ease-in-out text-math-600',
            theme === 'dark'
        ...
        <Moon
          size={iconSize[size]}
          className={cn(
            'transition-all duration-300 ease-in-out text-privacy-600',
            theme === 'dark'
              ? 'rotate-0 scale-100 opacity-100'
              : '-rotate-90 scale-0 opacity-0'
          )}
...
export function DropdownThemeToggle({
  ...
  return (
    <div className={cn('relative', className)} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 right-0 min-w-[240px] bg-popover border border-border rounded-lg shadow-lg z-50 py-1">
  ...
  if (!mounted) {
    return (
      <div className={cn('flex items-center gap-1', className)}>
        <div className="animate-pulse h-3 w-3 rounded bg-muted" />
